---
name: controlled-vocabulary-builder
description: Use to build and maintain a project-scoped, evolving controlled vocabulary / ontology that disambiguates concepts, supports retrieval, and underpins synthesis. Cross-cited by Bergeron (Essentials of KM), Bell (Librarian's Guide on MeSH), and Abbott (Digital Paper on personal CV).
metadata:
  portable: true
  compatible_with:
    - claude-code
