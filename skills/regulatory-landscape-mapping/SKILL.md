...
description: Use when researching the legal, statutory, regulatory, and case-law context that frames a research domain — particularly multi-jurisdiction East African work. Produces structured regulatory-landscape files for any cohort affected by law.
metadata:
  portable: true
  compatible_with:
    - claude-code
