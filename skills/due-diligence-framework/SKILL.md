...
description: Use when conducting pre-investment, pre-partnership, or pre-hire due diligence on a named entity (person, company, asset). Sets the green/amber/red flag framework, the verification rigour, and the schema-F report structure.
metadata:
  portable: true
  compatible_with:
    - claude-code
