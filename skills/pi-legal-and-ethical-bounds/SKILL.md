---
name: pi-legal-and-ethical-bounds
description: Use as the legal/ethics gate before any investigative collection that touches surveillance, recording, GPS, pretexting, or US-style protected data classes. Federal + state matrix; what's lawful, what's actionable, what's criminal. From McMahon + post-2001 legal overlay.
metadata:
  portable: true
  compatible_with:
    - claude-code
