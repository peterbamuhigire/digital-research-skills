---
name: due-diligence-report-architecture
description: Use to assemble a DD-grade report — Hetherington's canonical skeleton with Privileged & Confidential cover, executive summary FIRST, red/amber/green flag table, body in priority order, fixed liability disclaimer. Backed by tools/dd/report_builder.py.
metadata:
  portable: true
  compatible_with:
    - claude-code
