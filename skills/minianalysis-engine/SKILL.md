---
name: minianalysis-engine
description: Use as the universal unit of research progress — decomposes any research question into bounded ≤1-week atomic minianalyses that each become a stand-alone paragraph or section in the final report. Adapted from Andrew Abbott, Digital Paper.
metadata:
  portable: true
  compatible_with:
    - claude-code
