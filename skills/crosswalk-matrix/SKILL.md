---
name: crosswalk-matrix
description: Use to bridge discovery and synthesis — a live matrix of research-questions × sources where each populated cell is a minianalysis. The single most useful research-management artefact after the design document. Adapted from Andrew Abbott, Digital Paper.
metadata:
  portable: true
  compatible_with:
    - claude-code
