---
name: web-search-operator-grammar
description: Use when constructing web-search queries — defines the operator stack (punctuation, field, refinement, Boolean) for Google / Bing / DuckDuckGo / Kagi / Brave / Perplexity-class engines. The lowest layer of search craft, beneath every other research skill. Adapted from Amanda Deason, Internet Research with Google.
metadata:
  portable: true
  compatible_with:
    - claude-code
