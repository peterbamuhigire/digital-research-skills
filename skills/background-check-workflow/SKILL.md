...
description: Use to run a structured FCRA-compliant background check from intake to final report — disclosure & release, public-records sweep, federal courts, regulatory filings, business profile, principals review, source interviews, interim + final report. From McMahon's Practical Handbook for Private Investigators.
metadata:
  portable: true
  compatible_with:
    - claude-code
