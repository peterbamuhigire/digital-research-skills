---
name: source-synthesis-craft
description: Use to combine multiple sources into a single paragraph or argument — the strongest plagiarism shield. Patterns for agreement, disagreement, supplementation, and gap-naming across sources.
metadata:
  portable: true
  compatible_with:
    - claude-code
