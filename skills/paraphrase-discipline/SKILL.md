---
name: paraphrase-discipline
description: Use when converting source material into the engine's own words — true paraphrase (structural reorganisation) vs synonym-swap (word substitution). Backed by tools/academic/paraphrase.py.
metadata:
  portable: true
  compatible_with:
    - claude-code
