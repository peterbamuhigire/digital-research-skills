---
name: evidence-custody-discipline
description: Use whenever physical or digital evidence will be presented in court — chain-of-custody ledger, six-step procedure (protect/collect/identify/preserve/transmit/dispose), three-factor admissibility test. Backed by tools/pi/chain_of_custody.py. From McMahon's Practical Handbook for Private Investigators.
metadata:
  portable: true
  compatible_with:
    - claude-code
