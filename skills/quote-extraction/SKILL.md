...
description: Use when pulling verbatim attributable quotes from research sources for inclusion in reports, persona work, or pitch decks. Distinguishes primary vs secondary vs paraphrased quotes and standardises attribution.
metadata:
  portable: true
  compatible_with:
    - claude-code
