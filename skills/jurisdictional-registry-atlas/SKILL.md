---
name: jurisdictional-registry-atlas
description: Use to look up the canonical corporate / securities / AML-FIU / court / sanctions registry for any country — Hetherington Appendix E in machine-readable form. Backed by tools/dd/registry_atlas.py.
metadata:
  portable: true
  compatible_with:
    - claude-code
