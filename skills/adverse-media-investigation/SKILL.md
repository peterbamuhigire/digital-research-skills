---
name: adverse-media-investigation
description: Use to surface negative-news / scandal / litigation coverage on a person or entity, with anti-defamation discipline. Multi-engine, multi-term, identifier-anchored. Backed by tools/dd/adverse_media.py.
metadata:
  portable: true
  compatible_with:
    - claude-code
