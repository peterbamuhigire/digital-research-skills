...
description: Use when profiling persons, organisations, domains, or infrastructure from open sources. Defines the legal, ethical, and verification rigour distinct from general research and from due diligence.
metadata:
  portable: true
  compatible_with:
    - claude-code
