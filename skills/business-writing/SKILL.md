...
| `references/growth-profit-and-disruption-analysis.md` | Growth-system mapping, binding constraint, profit-lever decomposition, disruption vs incremental test, challenge questions, experiment plan |
